...
for i = 1:M
    ...
    inter_realmin = delta*real(qam_symbol(i))-abs(10*delta*real(qam_symbol(i)));
    inter_realmax = delta*real(qam_symbol(i))+abs(10*delta*real(qam_symbol(i)));
    inter_imagmin = delta*imag(qam_symbol(i))-abs(10*delta*imag(qam_symbol(i)));
    inter_imagmax = delta*imag(qam_symbol(i))+abs(10*delta*imag(qam_symbol(i)));
